 ...
 */
package com.siwind.sdn.opendaylight.cli.commands;
...
public class OdlHelloCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(OdlHelloCliTestCommand.class);
    protected final OdlHelloCliCommands service;

    public OdlHelloCliTestCommand(final OdlHelloCliCommands service) {
